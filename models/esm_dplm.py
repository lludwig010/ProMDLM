...
from transformers.models.esm.modeling_esm import EsmSelfAttention, EsmAttention, EsmLayer, EsmSelfOutput, EsmIntermediate, EsmOutput, EsmEncoder, EsmModel, EsmEmbeddings, EsmPooler, EsmContactPredictionHead, EsmForMaskedLM, EsmPreTrainedModel, EsmLMHead
...
class EsmForDPLM(EsmForMaskedLM):
    def __init__(self, config, dropout=0.1):
        tokenizer = AutoTokenizer.from_pretrained(config._name_or_path) # config._name_or_path = 'facebook/esm2_t30_150M_UR50D' 
